...
public class RoomResourceTest {
	...
	public void testgetRooms() {
		...
		List<Room> listarooms = Arrays.asList(
				new Room(cinema1, filmA, "ZUBIARTE SALA 1", Calendar.getInstance().getTime(), 100),
				new Room(cinema1, filmB, "ZUBIARTE SALA 2", Calendar.getInstance().getTime(), 100),
				new Room(cinema1, filmC, "ZUBIARTE SALA 3", Calendar.getInstance().getTime(), 100));
